from text_proccesing.unique_counter import story
from text_proccesing.unique_counter import unique_words
...
def get_random_movie_discription(rating: float) -> str:
  movie_with_rating = filter(lambda item: float(item["rating"]) >= rating, imdb_rank)
  movie = list(movie_with_rating)
  selected_movie = choice(movie)
  return selected_movie["description"]

print(get_random_movie_discription(8.2))


print(unique_words(get_random_movie_discription(8.2)))
